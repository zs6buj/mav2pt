...
// Slave advertises hostname for pairing, master connects to slavename
 ...
 //=================================================================================================
    ...
    DisplayPrintln("SD support activated");
...
void main_loop() {
 ...
 //====================     S P o r t   S e n d   a n d   R e c e i v e
  ...
  //===============   Check For Display Scroll Button Touch / Press
    ...
    #if (defined ESP32)               // uses interrupt
      if (upButton) {
        Scroll_Display(up);
      }
      if (dnButton) {
...
//================================================================================================= 
    ...
    void Scroll_Display(scroll_t up_dn) {
      ...
      if (up_dn == up) {
         ...
         upButton = false; 
         PaintDisplay(scroll_row, show_last_row);   
      }
      if (up_dn == down) {
          scroll_row++; 
          scroll_row = constrain(scroll_row, screen_height, row);       
    ...
    //===================================
    void PaintDisplay(uint8_t to_row, last_row_t last_row_action  ) {
...
//=================================================================================================  
    ...
    if (!apFailover) {   
      ...
      if (WiFi.status() == WL_CONNECTED) {
        ...
        if (set.wfproto == udp)  {  // UDP
          ...
          DisplayPrint("UDP port = ");  DisplayPrintln(String(set.udp_localPort));
        }
  ...
  if ((set.wfmode == ap) || (set.wfmode == sta_ap)) { // AP mode or STA failover to AP mode
    if (!wifiSuGood) {  // not already setup in STA above  
      ...
      DisplayPrintln(String(set.apSSID));
      ...
      if (set.wfproto == tcp)  {         // TCP
          ...
          DisplayPrint("TCP port = ");  DisplayPrintln(String(set.tcp_localPort));
        }
  ...
  //=================================================================================================  
   void PrintRemoteIP() {
    if (FtRemIP)  {
      ...
      DisplayPrintln(String(set.udp_remotePort));
     }
  }
#endif 
//=================================================================================================   
