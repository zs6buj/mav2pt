...
//=================================================================================================  
  ...
  //===============================       H a n d l e   W i F i   E v e n t s 
   ...
   if ( (set.fc_io == fc_wifi) && (set.gs_io == gs_wifi) ) {  // if user selects wifi uplink AND wifi downlink simultaneously, then wifi mode must be ap_sta
     if (set.wfmode != ap_sta) {
       Log.println("User selected wifi uplink AND wifi downlink simultaneously. Switching to AP_STA mode");  
       set.wfmode = ap_sta;    
     }
   }
