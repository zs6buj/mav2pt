...
void DisplayPrint(String);
  ...
  FrSkyPort FrPort;   // instantiate F/SPort object   
...
//=================================================================================================
  ...
  if (set.frport == f_port) {
    Debug.println("F.Port Version");
    DisplayPrintln("F.Port Version");
  } else  
  if (set.frport == s_port) {
    Debug.println("S.Port Version");
    DisplayPrintln("S.Port Version");
  }
...
void loop() {
 ...
 //====================     F P o r t   H a n d l e   T r a f f i c
...
//=================================================================================
  ...
  sprintf(temp, "<input type='radio' class='big' name='_frport' value='SPort' %s> SPort &nbsp &nbsp &nbsp &nbsp", set.frport1);
  settingsPage += temp;
  sprintf(temp, "<input type='radio' class='big' name='_frport' value='FPort' %s> FPort &nbsp <br>", set.frport2);
  settingsPage += temp;  
  ...
  settingsPage += temp;
  sprintf(temp, "<input type='radio' onclick=checkserial(this.form) class='big' name='_gs_io' value='Serial' %s> Serial &nbsp &nbsp", set.gs_io0);
  settingsPage += temp;
  #if (defined ESP32) && (defined btBuiltin) 
...
void RawSettingsToStruct() {
  ...
  #if (defined SPort_Version) 
    set.frport = s_port;
  #elif (defined FPort_Version)   
    set.frport = f_port;                
  #endif
