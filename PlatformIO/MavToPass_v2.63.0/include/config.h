...
#define SPort_Version
//#define FPort_Version     // v1/v2 FrSky ISRM/ACCESS capable transmitters and receivers only
...
//#define Display_Support                 // Enable if you have a display attached - choose display type where board variant is defined
...
#if ((not defined SPort_Version) && (not defined FPort_Version)) || ((defined SPort_Version) && (defined FPort_Version)) 
  #error define either SPort_Version or FPort_Version
#endif    
//=================================================================================================   
...
//================================================================================================= 
  ...
  //=========================================================================   
   ...
   //=========================================================================   
  #if (ESP32_Variant == 6)          // LILYGO® TTGO T2 SD TFT Colour   IDE board = "ESP32 Dev Module"
    ...
    #define startWiFiPin  99        // 99=none. No input pin available (non touch!) Could use touch with a bit of messy work.
      ...
      #define Display_Support
    #endif
    #define SSD1331_Display         // colour TFT display type 
  ...
  //=================================================================================================  
    ...
    //==========================================================  
    #elif (defined SSD1331_Display)    // SSD1331 colour TFT display    
