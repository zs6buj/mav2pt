...
//#define Reset_Web_Defaults            // Reset settings in eeprom. Do this if eeprom settings are corrupt.

//#define SD_Support                    // Enable if you have an SD card reader attached

#define Display_Support               // Enable if you have a display attached - enable on display type below
...
#define RSSI_Override     70  // Only if (RSSI == 0) force it to value, but only sent when Mavlink good. Replace PR by Hasi123 (if no rssi, force 69%)                                                                                                            
...
//   N O T E:  G P I O 1 2  is a bootstrap pin on the ESP32 - avoid GPIO12 high on bootup
   ...
   //                     D4        // TXD1 - Serial1 debug log out SHARED WITH BOARD LED                         
    ...
    #if (defined Display_Support)   // Display type defined near top of page
      #define Pup           D3      // Pin to ground to scroll the display up
      #define Pdn           D7      // Pin to ground to scroll the display down   
    #endif
    ...
    #define startWiFiPin  D6        // Trigger WiFi startup 
                                    // NOTE: There are not enough pins for wifi pin and display scrolling  
    #if (defined Display_Support)   // Display type defined near top of page
      #define Pup           99      // 99=none or try D3/D7 Pin to ground to scroll the display up
      #define Pdn           99      // 99=none or try D3/D7 Pin to ground to scroll the display down   
    #endif    
    #if (defined SD_Support) || (defined Display_Support)
...
//=================================================================================================
  ...
  #define mvSerialFC          Serial2        // RXD2 and TXD2
