...
// Choose none or one only of these GCS side I/O channels
//#define GCS_Mavlink_IO  9    // NONE
//#define GCS_Mavlink_IO  0    // Serial Port (default)         
...
// Check #defines options logic
  ...
  #if (!Target_Board == 0) && (!Target_Board == 1) && (!Target_Board == 2) && (!Target_Board == 3) 
    ...
    #error Please choose at least one Mavlink In Mode
  #endif
...
void RB_To_Decode_To_SPort_and_GCS() {
                            ...
                            //***Mavlink From Ring Buffer to Decoder and GCS ***
     ...
     // mav2
       ...
       //   fr_chunk_pntr = 0;
          ...
          if (MsgRingBuff.isFull()) {
            ...
            Debug.print("Mavlink in #253 Statustext pushed onto R2GmsgRingBuff: ");
            Debug.print("Queue length= "); Debug.print(R2GmsgRingBuff.size());
            Debug.print(" R2Gmsg lth="); Debug.print(len);
