...
//=================================================================================================  
  if ((set.fc_io == fc_ser) || (set.gs_io == gs_ser))  {  //  Serial 
      ...
      delay(100);
          ...
          //gsSerial.begin(set.baud);                  // but does use gsSerial
      #else   // not variant 8, but regular esp32    
    ...
    #if (defined ESP32) && (ESP32_Variant == 8)   
        log.printf("Mavlink GS serial on pins rx:%d and tx:%d  baud:%d\n", gs_rxPin, gs_txPin, set.baud);
    #else          
