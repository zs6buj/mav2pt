...
*/
    ...
    #define InvertMavLed   false     
    #define BufStatusLed    -1        // none  
    #define fc_rxPin        16        // not used
    #define fc_txPin        21        // not used
    #define fr_rxPin        -1        // FPort u2rxd - map a spare pin
    #define fr_txPin        -1        // FPort u2txd - map a spare pin
    #define sbus_rxPin      -1        // not used - don't care
...
#if (ESP32_Variant == 8)
   #if (GCS_Mavlink_IO == 0) 
     #if ((FC_Mavlink_IO == 0) || (FrSky_IO == 1))
       #error Not enough UARTS on ESP32S3
     #endif
   #endif
#endif   
...
#if (ESP32_Variant == 8)
  #if defined Support_SBUS_Out 
     #error This option currently unavalable    
  #endif 
#endif  
