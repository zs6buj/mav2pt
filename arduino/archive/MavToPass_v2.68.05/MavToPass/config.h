...
v2.68.05  2022-12025   Merged 2 PRs from Hasi123. Mavlink routing. Limit Mavlink message decodes 
...
#define mvBaud            57600      // Mavlink to/from the flight controller - 57600 to max 921600 - must match FC or long range radio
#define MavAutoBaud                  // Auto detect Mavlink telemetry speed regardless of above             
...
//================================================================================================= 
  ...
  //=========================================================================   
    ...
    #define InvertMavLed false     
    #define BufStatusLed  99        // none
    #define fc_rxPin      27        // Mavlink serial rx  WHITE
    #define fc_txPin      26        // Mavlink serial tx  LIGHT BLUE
...
//================================================================================================= 
  ...
  //==========================================================
    ...
    #if (defined ST7789_Display)      // TTGO T_Display 1.14 TFT display SPI
      #include <TFT_eSPI.h>           // REMEMBER to select the T-Display ST7789V SPI in User_Setup_Select.h in TFT_eSPI library folder
                                      // Also select ST7789 driver, then TFT_RGB_ORDER TFT_BGR, then WIDTH 240 and HEIGHT 320 in User_Setup.h
