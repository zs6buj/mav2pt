...
v2.67.02  2021-08-18   Add pin for on-the-fly reset of EEPROM/NVS to default settings in config.h
v2.67.03  2021-08-19   NVS reset pins for more variants.
v2.67.04  2021-08-19   Add NVS reset pins for ESP8266
                       Tinfo and Pinfo pins obsolete, removed code
v2.67.05  2021-09-11   Tidy up Mavlink BT to GCS    
V2.67.06  2021-11-25   Reset NVS settings to config settings if fw version change detected
                       On NVS reset call RawSettingsToStruct() and reboot  
...
v2.68.09 2024-05-03    Fix getBaud() int8_t for s_pins. Rationalise SWSERIAL/HWSERIAL for serial port requirements.
                       Line 845 mav2pt,  fcSerial->gsSerial                   
*/
