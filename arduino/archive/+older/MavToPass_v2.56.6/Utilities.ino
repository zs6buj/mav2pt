...
//=================================================================================================  
void ServiceStatusLeds(bool ledPolarity) {
  ServiceMavStatusLed(ledPolarity);
  if (BufStatusLed != 99) {
    ServiceBufStatusLed(ledPolarity);
  }
}
void ServiceMavStatusLed(bool ledPolarity) {
  if (mavGood) {
      MavLedState = HIGH;
     if (ledPolarity ==  LOW) {
        MavLedState = !MavLedState;
      }
...
void ServiceBufStatusLed(bool ledPolarity) {
 if (ledPolarity ==  LOW) {
    BufLedState = !BufLedState;
  }
