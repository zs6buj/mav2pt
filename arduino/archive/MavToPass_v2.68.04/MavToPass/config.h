...
v2.68.04  2022-11-15   Marc tests                                                                                                      
*/
...
#define STAssid              "AstonWLAN"         // Target AP to connect to (in STA mode) <====
#define STApw                "88bcc81881"         // Target AP password (in STA mode). Must be >= 8 chars      
