...
//================================================================================================= 
  ...
  //========================================================================= 
    ...
    #define startWiFiPin  18        // Trigger WiFi startup
      ...
      #define Tinfo         99        //    Touch pin to trigger information display
  ...
  //=========================================================================   
    ...
    #define Pinfo         99        // 02 Digital pin to trigger information display
    #define Tup           33        // 33 Touch pin to scroll the display up
    #define Tdn           32        // 32 Touch pin to scroll the display down 
    #define Tinfo         02        // 02 Touch pin to trigger information display
