...
void Send_GPS_Status5002() {
  ...
  fr_gps_stat_b = fr_gps_status > 3 ? fr_gps_status - 3 : 0;      
          
  fr_amsl = ap_amsl24 / 100;  // dm
  fr_hdop = ap_eph /10;
          
  bit32Pack(fr_gps_stat_a ,4, 2);
  bit32Pack(fr_gps_stat_b ,14, 2);
    ...
    Debug.print(" fr_gps_stat_b="); Debug.print(fr_gps_stat_b);
...
void Send_Bat1_5003() {
  ...
  #if defined Frs_Debug_All || defined Frs_Debug_Bat1
