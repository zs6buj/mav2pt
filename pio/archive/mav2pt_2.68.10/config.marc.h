...
#define STAssid              "Dornan"         // Target AP to connect to (in STA mode) <====
#define STApw                "3127313834"         // Target AP password (in STA mode). Must be >= 8 chars      
...
//================================================================================================= 
  ...
  //=========================================================================   
  #if (ESP32_Variant == 4)          // Heltec Wifi Kit 32 (NOTE! 8MB) V3
    #define MavStatusLed    25        // Onboard LED
    #define InvertMavLed   false     
    #define BufStatusLed    99        // none  
    #define fc_rxPin        99        // Mavlink serial rx was 27
    #define fc_txPin        99        // Mavlink serial tx was 17
    #define fr_rxPin        99        // FPort rx - (NOTE: DON'T use pin 12! boot fails if pulled high) 4
    #define fr_txPin        99        // FPort tx - Use me in single wire mode was 14 now 46
    #define sbus_rxPin      99        // not used - don't care
    #define sbus_txPin      99        // ?Optional SBUS out pin   was 18 now 6
    #define startWiFiPin    99        // Trigger WiFi startup was
    #define resetEepromPin  05        // 5, 99=none use non digital touch pin
    #define gs_rxPin 2 // Optional GCS rx3
    #define gs_txPin 3 // Optional GCS tx3
