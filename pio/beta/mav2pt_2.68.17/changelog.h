...
v2.68.06  2023-08-11   Add support for LilyGo T-Display-S3  
                       FC WiFi and GCS serial special variant for marc dornan. Add SWSERIAL for GCS serial.     
...
v2.68.08 2023-08-17pm  Add support for LILYGO T-HMI ESP32-S3 2.8 inch Resistive Touch Screen TF card   
v2.68.09 2024-05-03    Fix getBaud() int8_t for s_pins. Rationalise SWSERIAL/HWSERIAL for serial port requirements. 
v2.68.10 2024-05-27    Add unused GCS pins for uart to uart on all other variants   
v2.68.11 2024-06-02    Blink Flight_Info_Display when rssi <= rssi_blink_threshold 
v2.68.12 2024-08-01    Include Tor Berg's Teensy 4.x PR         
v2.68.13 2024-09-26    Update WiFi event handling  
v2.68.14 2024-09-27    TFT_eSPI library, update User_Setup.h and User_Setup_Select.h
                       Change _Display to _DISPLAY. Test PIO auto board select.
v2.68.15 2024-12-12     Merge ST7789V into ST7789 display config.
                        Improve Lilygo T-Display_S3 config for PIO      
         2024-12-13     Don't reboot on STA failoiver to AP   
v2.68.16 2025-05-17     Add back support for ESP8266
v2.68.17 2025-05-17     Add back support for heltec_wifi_kit_32
*/
