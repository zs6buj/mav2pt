...
//=================================================================================================
    ...
    #endif 
    #if (defined ST7789_DISPLAY)  // LILYGO® TTGO T-Display ESP32 
...
//================================================================================================= 
    ...
    void setupLogDisplayStyle() {
      ...
      #if (defined ST7789_DISPLAY)  // LILYGO® TTGO T-Display Colour LCD
        #if (SCR_ORIENT == 0)           // portrait
   ...
   //===================================
    ...
    void setupInfoDisplayStyle() {
      ...
      #if (defined ST7789_DISPLAY)      // LILYGO® TTGO T-Display Colour LCD    // LILYGO® TTGO T-Display ESP32 1.14" ST7789 Colour LCD
        #if (SCR_ORIENT == 0)           // portrait
