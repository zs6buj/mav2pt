...
//#define GCS_Mavlink_IO  3    // SD Card
...
//************************************************************************** 
//******************************* SD Card **********************************
  #if ((FC_Mavlink_IO == 3) || (GCS_Mavlink_IO == 3))  // SD Card
...
CircularBuffer<ST_t, 10> MsgRingBuff; 
...
#if (GCS_Mavlink_IO == 0) || (GCS_Mavlink_IO == 1) || (GCS_Mavlink_IO == 2) || (GCS_Mavlink_IO == 3)
     ...
     // mav2
       ...
       //   fr_chunk_pntr = 0;
          ...
          if (MsgRingBuff.isFull()) {
            ...
            ST_Rec.severity = ap_severity;
            memcpy(ST_Rec.text, ap_text, ap_txtlth+ 4);   // length + rest of last chunk at least
            ST_Rec.txtlth = ap_txtlth;
            ST_Rec.simple = ap_simple;
            MsgRingBuff.push(ST_Rec);
          }
