...
v2.58   2020-03-17 Work around apparent bug in Mavlink V2 Library. Tolerate crc errors
...
#define ESP_Invert               // = default, otherwise conventional two-wire uninverted (normally high)
...
//================================================================================================= 
  ...
  #define FC_Mav_txPin  10
  #if (SPort_Serial == 1)
    #define Fr_txPin       1      // Not soft configuarable. Change wiring 
    #define GC_Mav_rxPin   7    
    #define GC_Mav_txPin   8   
  #elif (SPort_Serial == 3)
    define Fr_txPin        8      // Not soft configuarable. Change wiring   
  #endif  
    ...
    */
    ...
    #if not defined OLED_Support    // I2C OLED board is built into Heltec WiFi Kit 32
      #define OLED_Support
    #endif
