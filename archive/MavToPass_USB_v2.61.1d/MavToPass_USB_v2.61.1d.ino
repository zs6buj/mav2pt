...
void Pack_Parameters_5007(uint16_t, uint8_t);
...
void setup()  {
  ...
  #if (FC_Mavlink_IO == 4)                                 // if Mavlink in on USB<=>UART0    
    Debug.begin(115200, SERIAL_8N1, Dbg_rxPin, Dbg_txPin); // move debuggiong to UART2
  #else
    Debug.begin(115200);                                   // else on UART0
  #endif  
...
//=================================================================================================
  ...
  if (set.fc_io == fc_ser)   {
    #if (FC_Mavlink_IO == 4)  // if Mavlink in on USB<=>UART0   
    Debug.println("Mavlink USB In");
    OledPrintln("Mavlink USB In");
    #else
...
//=================================================================================================  
  ...
  if (set.fc_io == fc_ser)  {  //  Serial
      ...
      set.baud = GetBaud(FC_Mav_rxPin);
        ...
        Debug.println("Mavlink serial input on USB"); 
      #else
    ...
    //      Debug.printf("matched row mt20_row=%d\n", mt20_row);
          ...
          switch(ap_param_index) {      // if #define Battery_mAh_Source !=1 these will never arrive
            case 356:         // Bat1 Capacity
              ...
              PackSensorTable(0x5007, 4);    // Bat1 capacity
            ...
            case 364:         // Bat2 Capacity
              ...
              PackSensorTable(0x5007, 5);    // Bat2 capacity
     ...
     // mav2
        ...
        case MAVLINK_MSG_ID_MISSION_COUNT :          // #44   received back after #43 Mission_Request_List sent
          ...
          if (!mavGood) break;  
            ...
            PackSensorTable(0x5007, 6);    // fr parameters - mission count
