...
/*  *****************************************************************************
    ...
    MavToPassthruPlusESP  JMay 2019
...
SSD1306Wire  display(0x3c, 19, 18); // SDA  SCL TTGO 5, 4);  //  SDA  SCL  ESP Dev 19, 18);  //  21, 22);
...
#define BT_Enabled                  // Bluetooth Classic - Only possible on ESP32
...
*/
 ...
 //   mavSerial.begin(mavBaud, SERIAL_8N1, 9, 10);
  ...
  #if defined BT_Enabled
    Debug.println("BT enabled");
    OledDisplayln("BT enabled");
  #endif  
...
void BT_ReceiveAndForward() {   // up to FC, optional
#if defined BT_Enabled
  mavlink_message_t msg; 
  mavlink_status_t status;
  ...
  while(SerialBT.available()) 
    ...
    if(mavlink_parse_char(MAVLINK_COMM_0, c, &msg, &status)) {
      ...
      #ifdef  Debug_BT
        Debug.println("SerialBT passed up to FC:");
        PrintMavBuffer(&msg);
      #endif
