...
// Check #defines options logic
    ...
    #error Sorry - AP mode does not support UDP protocol
     ...
     #error Can't have SD IO on FC side at the same time as on the GCS side
  #endif   
...
// Scheduler buffer
 ...
 typedef struct  {
  ...
  const uint8_t st_rows = 120;  // possible unsent sensor ids at any moment - cater for 12 status text chunks x 3 + unsent
