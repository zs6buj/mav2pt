...
//#define Support_SBUS_Out  // Derive SBUS for F.Port and present it on a uart tx pin - ESP only for now

#if defined Support_SBUS_Out // Then we need uart1 for the SBUS out
